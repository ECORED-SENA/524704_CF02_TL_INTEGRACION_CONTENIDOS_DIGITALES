<template lang="pug">
  .curso-main-container.pb-3
    ...
    .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
      ...
      .bg-full-width.bg-color-3
        .px-4.px-md-5.py-4
          .row.justify-content-center.align-items-center.mb-5
            .col-lg-3.mb-3.order-lg-2(data-aos="fade-right")
              figure
          ...
          p.mb-5(data-aos="fade-right") El montaje audiovisual constituye, por tanto, la fase técnica y narrativa final del producto audiovisual. Aunque se concreta en la etapa de posproducción, su sentido queda previamente definido desde la elaboración del guion, ya que responde a las intenciones del emisor y a las capacidades interpretativas del receptor.
          ...
          p.mb-5(data-aos="fade-right") A continuación, se presentan las definiciones fundamentales que orientan este apartado:
      ...
      p.mb-5(data-aos="fade-right") En síntesis, mientras la edición se centra en la manipulación técnica del material audiovisual, el montaje implica una construcción narrativa que organiza los fragmentos en una estructura significativa. Ambos procesos son complementarios y esenciales en la producción audiovisual.
      separador
      ...
      .bg-full-width.bg-color-3
        .px-4.px-md-5.py-4
          .row.justify-content-center.align-items-center.mb-5
            .col-lg-4.mb-3.order-lg-2(data-aos="fade-right")
              figure
          ...
          p.mb-5(data-aos="fade-right") Estos componentes participan en la conversión de la información lumínica en datos numéricos que posteriormente pueden ser procesados digitalmente.
          .titulo-con-imagen.mb-5(data-aos="fade-right")
            .titulo-con-imagen__fondo
              img.titulo-con-imagen__imagen(src="@/assets/componentes/1.png")
              h3.titulo-con-imagen__texto La imagen digital
          p(data-aos="fade-right") Según la <b>Real Academia Española</b> (s. f.), una imagen es toda forma o figura percibida por el sentido de la vista.
          p.mb-5(data-aos="fade-left") Desde el ámbito tecnológico, una <b>imagen digital o gráfico digital</b> se define como una representación bidimensional construida a partir de una matriz numérica, generalmente expresada en sistema binario (unos y ceros). Esta información se almacena en la memoria de un sistema informático y posteriormente es interpretada por el dispositivo para su representación en pantalla o su impresión mediante periféricos de salida.
          div.bg-color-6.p-3.d-inline-flex.tarjeta.mb-3(data-aos="fade-down")
      ...
      p.mb-5(data-aos="fade-left") De acuerdo con Ordóñez (2005), una imagen en mapa de bits es una estructura de datos que representa una rejilla rectangular de píxeles. Cada píxel es una unidad mínima sin dimensión física concreta y constituye la base de fotografías, fotogramas de video y gráficos digitales.
      .titulo-con-imagen.mb-5(data-aos="fade-right")
        .titulo-con-imagen__fondo
          img.titulo-con-imagen__imagen(src="@/assets/componentes/1.png")
          h3.titulo-con-imagen__texto Elementos de la imagen digital
      p.mb-5(data-aos="fade-left") Una vez comprendidos los tipos de imagen, es pertinente abordar los elementos que determinan su construcción y posterior edición.
      ...
      p.mb-5(data-aos="fade-right") En consecuencia, la elección del formato depende del uso final del archivo, la calidad requerida y el medio de distribución.
      div.bg-color-6.p-3.d-inline-flex.tarjeta.mb-3
        h4.mb-0 Resolución de la imagen
      p.mb-5(data-aos="fade-left") La resolución se relaciona con el tamaño y la densidad de píxeles que conforman la imagen. Este concepto involucra tres dimensiones:
      .row.mb-5.justify-content-center
        .col-sm-6.col-lg-4.mb-4.mb-lg-0(data-aos="fade-up")
          //- .tarjeta--boton debe ir acompañado de una de una de estas clases => 
          //- .color-primario, .color-secundario, .color-acento-contenido, .color-acento-botones
      ...
      p.mb-5(data-aos="fade-left") La edición digital integra dimensiones creativas y técnicas que se complementan en la construcción del mensaje visual.
      .tarjeta--container.row.mb-5(data-aos="fade-right")
      ...
      p.mb-5(data-aos="fade-left") Las herramientas de edición corresponden a los diferentes programas de tratamiento de imagen disponibles en el mercado. Estas aplicaciones se clasifican según el entorno en el que operan: computador, dispositivos móviles o plataformas en línea.
      .row.mb-5.justify-content-center
        .col-sm-6.col-lg-4.mb-4.mb-lg-0(data-aos="fade-up")
          //- .tarjeta--boton debe ir acompañado de una de una de estas clases => 
          //- .color-primario, .color-secundario, .color-acento-contenido, .color-acento-botones
      ...
      .bg-full-width.bg-color-3
        .px-4.px-md-5.py-4
          p.mb-5(data-aos="fade-left") A continuación, se relacionan algunos ejemplos representativos:
      ...
      p.mb-5(data-aos="fade-left") Finalmente, las aplicaciones pueden clasificarse según su modelo de licencia.
      .row.mb-5.justify-content-center.align-items-center
        .col-lg-5.col-xl-6.mb-3.mb-lg-0.order-lg-2(data-aos="fade-left")
          figure
            img(src="@/assets/curso/tema1/46.png", data-aos="zoom-in")
        .col-lg-7.col-xl-6.order-lg-1(data-aos="fade-right")
          .row.justify-content-center
              ...
              .bg-color-4.p-4
                ...
                ul.lista-ul--color.ms-2.mb-0
                  ...
                  li.mb-1.d-flex
                    i.fas.fa-circle-check.bg-color-11
                    | <em>PicMonkey</em>
      p(data-aos="fade-left") En conclusión, la edición de imágenes articula intención conceptual, creatividad y dominio técnico. La elección del editor y del tipo de licencia dependerá del objetivo comunicativo, la complejidad del proyecto y el contexto de uso, ya sea digital o impreso.
      separador
      .bg-full-width.bg-color-3
        .px-4.px-md-5.py-4
      ...
      p.mb-5(data-aos="fade-up") En conclusión, la selección del formato de audio depende del contexto de uso, el medio de distribución y el equilibrio requerido entre calidad sonora y tamaño del archivo. Los formatos con pérdida permiten mayor compresión y menor peso, mientras que los formatos sin pérdida priorizan fidelidad de sonido a costa de mayor capacidad de almacenamiento.
      .titulo-con-imagen.mb-5(data-aos="fade-right")
        .titulo-con-imagen__fondo
          img.titulo-con-imagen__imagen(src="@/assets/componentes/1.png")
          h3.titulo-con-imagen__texto Programas para edición de audio <em>offline</em>
      p.mb-5(data-aos="fade-left") La edición de audio <em>offline</em> se realiza mediante programas instalados directamente en el computador o dispositivo, lo que permite trabajar sin conexión a internet y acceder a funciones avanzadas de grabación, mezcla y exportación de archivos sonoros. A continuación, se presentan algunos de los programas más utilizados, organizados según su compatibilidad con sistemas operativos.
      div.bg-color-6.p-3.d-inline-flex.tarjeta.mb-3
        h4.mb-0 Programas para Windows
      .bg-full-width.bg-color-3
        .px-4.px-md-5.py-4
          p.mb-5(data-aos="fade-left") En esta categoría se agrupan aplicaciones diseñadas específicamente para el sistema operativo Windows, con funciones que van desde tareas básicas hasta procesos avanzados de edición.
          SlyderF.mb-5(columnas="col-lg-6 col-xl-4")
      ...
      p.mb-5(data-aos="fade-up") La edición de video requiere de la manipulación de varios elementos, en donde la unión de varias imágenes y la adición de efectos digitales, como música, efectos y textos, posibilitan tener un resultado de un producto listo, pero que requiere de una serie de conocimientos que se amplían a continuación:
      figure.mb-5
        .video.mb-2
      ...
      .row.mb-5.align-items-center.justify-content-center
        .col-md-8.col-lg-3.mb-3.mb-lg-0(data-aos="fade-right")
          figure
      ...
      p.mb-5(data-aos="fade-right") Los <b>planos en movimiento</b> surgen cuando la cámara se desplaza para seguir la acción o explorar el espacio. Estos movimientos aportan dinamismo y enriquecen la narrativa audiovisual.
      .row.mb-5.justify-content-center
        .col-sm-6.col-lg-4.mb-4.mb-lg-0(data-aos="fade-up")
          //- .tarjeta--boton debe ir acompañado de una de una de estas clases => 
          //- .color-primario, .color-secundario, .color-acento-contenido, .color-acento-botones
      ...
      p(data-aos="fade-right") Según Racionero (2008), “los planos cinematográficos se clasifican según su tamaño y dependiendo de este tienen diferentes funciones y reciben distintos nombres”. Esta clasificación permite comprender cómo la distancia entre la cámara y el sujeto incide directamente en la intención narrativa y expresiva del producto audiovisual.
      p.mb-5(data-aos="fade-right") A continuación, se presentan los principales tipos de plano según sus características de encuadre e imagen:
      .bg-full-width.bg-fondo-slider.mb-5
        .p-4.p-lg-5
          SlyderA(tipo="b").bg-color-white.p-4.tarjeta
            .row.justify-content-center.align-items-center.p-3.p-lg-4
      ...
      p.mb-5(data-aos="fade-right") Esta clasificación demuestra que la selección del plano no es arbitraria, sino que responde a la intención expresiva, la carga emocional y la información que se desea comunicar.
      .titulo-con-imagen.mb-5(data-aos="fade-right")
        .titulo-con-imagen__fondo
          img.titulo-con-imagen__imagen(src="@/assets/componentes/1.png")
      ...
      .bg-full-width.bg-color-3
        .px-4.px-md-5.py-4
          p(data-aos="fade-right") El proceso de edición de video consiste en la creación de un producto audiovisual a partir de la selección y unión de fragmentos de video y audio previamente grabados mediante dispositivos digitales, como cámaras.
          p.mb-5(data-aos="fade-right") Históricamente, se distinguían dos formas de edición: analógica y digital. En la actualidad, la edición analógica se encuentra prácticamente descontinuada, y la producción audiovisual se desarrolla bajo entornos de edición digital, que ofrecen mayor precisión, flexibilidad y control técnico.
          .row.justify-content-center.mb-5
            .col-lg-10
              .bg-color-2.mb-5(data-aos="fade-up")
                .row.justify-content-center.align-items-center
      ...
      .row.justify-content-center
        .col-lg-10
          ...
          .tabla-a.color-primario.mb-5.tbl(data-aos="fade-left")
            table
              thead
                tr
